...
int i1 = st.executeUpdate("Insert into da_admin_worker (workername , email , address, phone ) values( " + "'" + 
		workername + "',"  + "'" + email + "', " + "'" + address + "'," + "'" + phone  + "'" + ")");

out.println("<html><meta http-equiv=\"refresh\" \r\n"
		+ "        content=\"5; url = dash_admin_worker.jsp\" /><body><b>" + "Inserted</b></body></html>");
