  ...
  <body style="background-color: rgb(196, 185, 185)">
    ...
    <%
					try {
						...
						ResultSet i = st.executeQuery("SELECT * from da_admin_user ");
						...
						while(i.next()) {
							...
							String car_reg = i.getString("car_reg");
							String phone = i.getString("phone");
							
							out.println("<tr><th>"+username+ "</th><th>"+email+ "</th><th>"+car_reg+"</th><th>"+phone+ "</th></tr>");
    ...
    <div id="adduserModal" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action ="dash_admin_user_1.jsp" method = "post">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <textarea name="car_reg" class="form-control" required></textarea>
              </div>
              <div class="form-group">
                <label>Phone</label>
